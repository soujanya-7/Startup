...
// Optional: If you want to use professional icons instead of emojis
import { FaGlobe, FaLinkedin, FaWhatsapp } from "react-icons/fa";
          ...
          <form className="contact-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="field">
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange({ ...e, target: { ...e.target, value: e.target.value.replace(/\D/g, "") } })
                }
